							...
							<div class="gallery" itemscope>
								<div class="row">
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{asset('img/gallery/project-1.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{asset('img/gallery/project-2.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{asset('img/gallery/project-3.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{asset('img/gallery/project-3.jpg" itemprop="thumbnail')}}" alt="Image description" />
										</a>
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="img/gallery/project-4.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{asset('img/gallery/project-4.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<!-- gallery item -->
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="{{asset('img/gallery/project-5.jpg')}}" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{asset('img/gallery/project-5.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
									...
									<figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
										<a href="img/gallery/project-6.jpg" itemprop="contentUrl" data-size="1920x1280">
											<img src="{{asset('img/gallery/project-6.jpg')}}" itemprop="thumbnail" alt="Image description" />
										</a>
